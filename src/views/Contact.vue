<template>
  <div id="contact">
    <section
      class="u-align-center u-clearfix u-section-1-contact"
      id="sec-11bd"
    >
        ...
        <div class="u-form u-form-1">
          ...
          >
            <div class="u-form-group u-form-name u-form-group-1">
              <label for="name-6797" class="u-form-control-hidden u-label"
                >Name</label
              >
              <input
                type="text"
            ...
            <div class="u-form-email u-form-group u-form-group-2">
              <label for="email-6797" class="u-form-control-hidden u-label"
                >Email</label
              >
              <input
                type="email"
    ...
    <section class="u-clearfix u-grey-5 u-section-2-contact" id="carousel_3743">
      <div class="u-clearfix u-sheet u-sheet-1">
          ...
          <div class="u-layout">
            <div class="u-layout-row">
                ...
                <div class="u-layout-col">
                  <div class="u-size-20">
                    <div class="u-layout-row">
                      ...
                      >
                        <div
                          class="u-container-layout u-valign-bottom-md u-valign-bottom-sm u-valign-bottom-xs u-valign-top-lg u-container-layout-1"
                        >
                          <span
                            class="u-icon u-icon-circle u-text-grey-30 u-icon-1"
                            ><svg
                              class="u-svg-link"
                          ...
                          <p class="u-text u-text-default u-text-1">
                            121 Rock Sreet, 21 Avenue,&nbsp;New York,&nbsp;NY
                            92103-9000
                          </p>
                          <span
                            class="u-icon u-icon-circle u-text-grey-30 u-icon-2"
                            ><svg
                              class="u-svg-link"
                              preserveAspectRatio="xMidYMin slice"
                              viewBox="0 0 512 512"
                      ...
                      >
                        ...
                        >
                          <span
                            class="u-icon u-icon-circle u-text-grey-30 u-icon-3"
                            ><svg
                              class="u-svg-link"
                              preserveAspectRatio="xMidYMin slice"
                              viewBox="0 0 384 384"
                  ...
                  <div class="u-size-40">
                    <div class="u-layout-row">
                      <div
                        class="u-container-style u-layout-cell u-left-cell u-size-60 u-layout-cell-3"
                      >
              ...
              <div class="u-size-30 u-size-60-md">
                <div class="u-layout-col">
                  <div
                    class="u-container-style u-layout-cell u-right-cell u-size-60 u-layout-cell-4"
                  >
                      ...
                      <div class="u-form u-form-1">
                        ...
                        >
                          ...
                          <div class="u-align-left u-form-group u-form-submit">
                            <a
                              href="#"
                              class="u-border-2 u-border-grey-75 u-btn u-btn-round u-btn-submit u-button-style u-none u-radius-30 u-btn-1"
                              >Submit</a
                            >
                            <input
                              type="submit"
